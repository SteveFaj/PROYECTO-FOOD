...
const createRecipeHandler = async (req, res) => {
    ...
    try{
        const {title, summary, healthScore, image,  steps, diets, costo} = req.body;
        console.log(costo, "costo");
        const nuevaRecipe = await createRecipe(title, summary, healthScore, image, steps, diets, costo);
